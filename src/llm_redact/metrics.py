...
class Metrics:
    def __init__(self, version: str) -> None:
        ...
        # Routing layer (docs/routing.md): (upstream, rule) -> requests the
        # routing layer delivered, and (from_upstream, to_upstream) -> fallback
        # re-issues. Both label sets are config-bounded (upstream names, rule
        # ids), never request-derived.
